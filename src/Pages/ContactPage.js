        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+243 99 58 68 621'} text2={'+243 89 39 35 041 '} title={'Phone'}/>
                    <ContactItem icon={email} text1={'vchihisa@gmail.com'} text2={'abcloremipsum@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'avenue de goma quartier Himbi 1 Goma '} text2={'RDC'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
